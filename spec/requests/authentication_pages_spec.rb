  ...
  describe "auuthorization" do
	...
	describe "when attempting to visit a protected page" do
	   ...
	   describe "after signing in" do
		...
		end #it "should render the desired protected page" do
	   end #describe "after signing in" do
	end #describe "when attempting to visit a protected page" do
	describe "in the Users controller" do

	   describe "visiting the edit page" do
		before { visit edit_user_path(user) }
		it { should have_selector('title', text: 'Sign in') }
	   end #describe "visiting the edit page" do
	 ...
	 it { should_not have_selector('title', text: full_title('Edit user')) }
       end #describe "visiting Users#edit page" do

       describe "submitting a PUT request to the User#update action" do
	 before { put user_path(wrong_user) }
	 specify { response.should redirect_to(root_path) }    
       end #describe "submitting a PUT request to the User#update action" do
